(function() {
      angular.module('d3').directive('lineChart', lineChart);
      lineChart.$inject = ['d3Service'];

      function lineChart(d3Service) {
            return {
                  restrict: 'EA',
                  scope: {},
			templateUrl: 'public/views/templates/lineChartInfo.html',
  ...
  function drawLineChart( elementId, data ) {
    ...
    var containerEl = document.getElementById( 'lineChart' ),
